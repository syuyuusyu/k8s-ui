...
@inject('rootStore')
@observer
class PvConfiguration extends Component {
...
@inject('rootStore')
@observer
class PvSummary extends Component {
    componentDidMount() {
...
@inject('rootStore')
@observer
class PvYaml extends Component {
    componentDidMount() {
        const store = this.props.rootStore.store('pv')
...
@inject('rootStore')
@observer
class PvTabs extends Component {
    state = {}
    static getDerivedStateFromProps(props, state) {
        const store = props.rootStore.store('pv')
